...
- Currently focusing on security
...
- **Security**: Application and infrastructure security fundamentals
- **Web & Desktop**: Python web frameworks, Nest, Tauri, React, Angular
- **Infra & DevOps**: Kubernetes, ArgoCD, Docker Swarm, Terraform, Portainer
- **Data & ETL**: Airflow, PostgreSQL, Spark, Glue, Redshift, RDS
- **Cloud**: AWS, GCP

## Certificates
- CompTia Security+ (5271902b8d4c4848a0d61eb37048e0db)
